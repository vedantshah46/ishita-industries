...
export const staticProductDetails = {
  ...
  'brass-turned-component': {
    ...
    name: 'Brass Turned Component',
    category: 'precision',
    description: `High-quality brass turned components manufactured using advanced CNC and secondary operations. We specialize in components for electrical, automotive, and industrial applications.`,
    image_url: turnedImage,
    product_images: [{ image_url: turnedImage, alt_text: 'Turned Component', sort_order: 0 }],
    product_specs: [
      { label: 'Tolerance', value: '0.01mm', sort_order: 0 },
      { label: 'Material', value: 'Free Cutting Brass IS 319 Type (I)', sort_order: 1 },
    ],
    product_tags: [{ tag: 'Metric ISO' }, { tag: 'BSP' }],
    related_products: [{ name: 'Industrial Components', image_url: machine2 }],
  },
  'brass-forged-component': {
    slug: 'brass-forged-component',
    name: 'Brass Forged Component',
    category: 'precision',
    description: `Precision brass forged components offering superior strength and durability. Our forging process ensures minimal waste and high structural integrity.`,
    image_url: forgedImage,
    product_images: [{ image_url: forgedImage, alt_text: 'Forged Component', sort_order: 0 }],
    product_specs: [
      { label: 'Process', value: 'Hot Forging', sort_order: 0 },
      { label: 'Finish', value: 'Natural / Nickel Plated', sort_order: 1 },
    ],
    product_tags: [{ tag: 'High Strength' }, { tag: 'Customized' }],
    related_products: [{ name: 'Section Components', image_url: machine3 }],
  },
  'brass-milling-component': {
    slug: 'brass-milling-component',
    name: 'Brass Milling Component',
    category: 'precision',
    description: `Custom brass milling components designed for complex geometries and tight tolerances. Ideal for high-precision engineering projects.`,
    image_url: millingImage,
    product_images: [{ image_url: millingImage, alt_text: 'Milled Component', sort_order: 0 }],
    product_specs: [
      { label: 'Machining', value: '3-Axis / 4-Axis Milling', sort_order: 0 },
    ],
    product_tags: [{ tag: 'Precision' }],
    related_products: [{ name: 'Precision Machining', image_url: machine1 }],
  },
  'brass-pressed-component': {
    slug: 'brass-pressed-component',
    name: 'Brass Pressed Component',
    category: 'precision',
    description: `Accurate brass pressed components for high-volume production needs. Consistent quality and dimensional accuracy across batches.`,
    image_url: pressedImage,
    product_images: [{ image_url: pressedImage, alt_text: 'Pressed Component', sort_order: 0 }],
    product_specs: [
      { label: 'Method', value: 'Power Pressing', sort_order: 0 },
    ],
    product_tags: [{ tag: 'Bulk Production' }],
    related_products: [{ name: 'Industrial Components', image_url: machine2 }],
  }
}
